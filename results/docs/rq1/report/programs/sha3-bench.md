...
![sha3-bench-speedup](./sha3-bench-speedup.png)
## Cycle count by profile

### Cycle count by profile (risc0)
  
![sha3-bench-risc0-cycle-count](./sha3-bench-risc0-cycle-count.png)
### Cycle count by profile (sp1)
  
![sha3-bench-sp1-cycle-count](./sha3-bench-sp1-cycle-count.png)
### Cycle count relation to measurement

#### Cycle count vs. prove
  
![sha3-bench-cycle-count-vs-prove](./sha3-bench-cycle-count-vs-prove.png)
#### Cycle count vs. exec
  
![sha3-bench-cycle-count-vs-exec](./sha3-bench-cycle-count-vs-exec.png)
## % faster
  
![sha3-bench-improvement](./sha3-bench-improvement.png)
### risc0 % faster
  
![sha3-bench-risc0-improvement](./sha3-bench-risc0-improvement.png)
### sp1 % faster
  
![sha3-bench-sp1-improvement](./sha3-bench-sp1-improvement.png)
## Duration

### prove duration
  
![sha3-bench-prove-duration](./sha3-bench-prove-duration.png)
#### risc0 prove duration
  
![sha3-bench-risc0-prove-duration](./sha3-bench-risc0-prove-duration.png)
#### sp1 prove duration
  
![sha3-bench-sp1-prove-duration](./sha3-bench-sp1-prove-duration.png)
### exec duration
  
![sha3-bench-exec-duration](./sha3-bench-exec-duration.png)
#### risc0 exec duration
  
![sha3-bench-risc0-exec-duration](./sha3-bench-risc0-exec-duration.png)
#### sp1 exec duration
