...
![npb-sp-speedup](./npb-sp-speedup.png)
## Cycle count by profile

### Cycle count by profile (risc0)
  
![npb-sp-risc0-cycle-count](./npb-sp-risc0-cycle-count.png)
### Cycle count by profile (sp1)
  
![npb-sp-sp1-cycle-count](./npb-sp-sp1-cycle-count.png)
### Cycle count relation to measurement

#### Cycle count vs. prove
  
![npb-sp-cycle-count-vs-prove](./npb-sp-cycle-count-vs-prove.png)
#### Cycle count vs. exec
  
![npb-sp-cycle-count-vs-exec](./npb-sp-cycle-count-vs-exec.png)
## % faster
  
![npb-sp-improvement](./npb-sp-improvement.png)
### risc0 % faster
  
![npb-sp-risc0-improvement](./npb-sp-risc0-improvement.png)
### sp1 % faster
  
![npb-sp-sp1-improvement](./npb-sp-sp1-improvement.png)
## Duration

### prove duration
  
![npb-sp-prove-duration](./npb-sp-prove-duration.png)
#### risc0 prove duration
  
![npb-sp-risc0-prove-duration](./npb-sp-risc0-prove-duration.png)
#### sp1 prove duration
  
![npb-sp-sp1-prove-duration](./npb-sp-sp1-prove-duration.png)
### exec duration
  
![npb-sp-exec-duration](./npb-sp-exec-duration.png)
#### risc0 exec duration
  
![npb-sp-risc0-exec-duration](./npb-sp-risc0-exec-duration.png)
#### sp1 exec duration
