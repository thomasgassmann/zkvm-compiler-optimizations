...
![polybench-trisolv-speedup](./polybench-trisolv-speedup.png)
## Cycle count by profile

### Cycle count by profile (risc0)
  
![polybench-trisolv-risc0-cycle-count](./polybench-trisolv-risc0-cycle-count.png)
### Cycle count by profile (sp1)
  
![polybench-trisolv-sp1-cycle-count](./polybench-trisolv-sp1-cycle-count.png)
### Cycle count relation to measurement

#### Cycle count vs. prove
  
![polybench-trisolv-cycle-count-vs-prove](./polybench-trisolv-cycle-count-vs-prove.png)
#### Cycle count vs. exec
  
![polybench-trisolv-cycle-count-vs-exec](./polybench-trisolv-cycle-count-vs-exec.png)
## % faster
  
![polybench-trisolv-improvement](./polybench-trisolv-improvement.png)
### risc0 % faster
  
![polybench-trisolv-risc0-improvement](./polybench-trisolv-risc0-improvement.png)
### sp1 % faster
  
![polybench-trisolv-sp1-improvement](./polybench-trisolv-sp1-improvement.png)
## Duration

### prove duration
  
![polybench-trisolv-prove-duration](./polybench-trisolv-prove-duration.png)
#### risc0 prove duration
  
![polybench-trisolv-risc0-prove-duration](./polybench-trisolv-risc0-prove-duration.png)
#### sp1 prove duration
  
![polybench-trisolv-sp1-prove-duration](./polybench-trisolv-sp1-prove-duration.png)
### exec duration
  
![polybench-trisolv-exec-duration](./polybench-trisolv-exec-duration.png)
#### risc0 exec duration
  
![polybench-trisolv-risc0-exec-duration](./polybench-trisolv-risc0-exec-duration.png)
#### sp1 exec duration
