...
pub fn unroll(a: &[i32; 256]) -> i32 {
    ...
    unsafe {
        std::arch::asm!(
            ...
            "add {sum:e}, [{array} + {i} * 4 + 16]",
            "add {sum:e}, [{array} + {i} * 4 + 20]",
            "add {sum:e}, [{array} + {i} * 4 + 24]",
            "add {sum:e}, [{array} + {i} * 4 + 28]",
            "add {sum:e}, [{array} + {i} * 4 + 32]",
            "add {sum:e}, [{array} + {i} * 4 + 36]",
            "add {sum:e}, [{array} + {i} * 4 + 40]",
            "add {sum:e}, [{array} + {i} * 4 + 44]",
            "add {sum:e}, [{array} + {i} * 4 + 48]",
            "add {sum:e}, [{array} + {i} * 4 + 52]",
            "add {sum:e}, [{array} + {i} * 4 + 56]",
            "add {sum:e}, [{array} + {i} * 4 + 60]",
            "add {i}, 16",
            "cmp {i}, 256",
            "jl 2b",
            array = in(reg) a.as_ptr(),
